...
# {TodosParams} validates GET /api/v1/todos params.
#
# @example When parms are invalid:
...
class TodosParams < ApplicationParams
  # @!method params
  #   It stores rules for validating GET /api/v1/todos endpoint params using dry-rb validation DSL.
  params do
