...
Application.boot(:models) do
  ...
  start do
    ...
    # If not cached, it wil be computed on demand.
    ...
    # The validation_helpers plugin contains validate_* method designed to be called inside Model#validate to perform validations.
    Sequel::Model.plugin(:auto_validations)
    Sequel::Model.plugin(:validation_helpers)

    # The prepared_statements plugin modifies the model
    # to use prepared statement for instance level inserts and updates
    Sequel::Model.plugin(:prepared_statements)

    # Allows easy access all models subclasses and descendent classes.
    ...
    Sequel::Model.extension(:named_timezones)

    # Use UTC time zone for saving time inside db
