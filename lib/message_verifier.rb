...
# {MessgeVerifier} makes it easy to generate and verify messages which are signed to prevent tampering.
...
class MessageVerifier
  class << self
    ...
    # @param [Integer] expires_at in secons telling when the message expires.
    ...
    # It decodes the data using ActiveSupport::MessageVerifier
    #
    # @param [String] message that will be used in decodin process.
    # @param [Symbol] purpose that describes how the messae will be used.
    #
